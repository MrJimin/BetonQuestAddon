...
//class NxBlockBreakObjectiveFactory(loggerFactory: BetonQuestLoggerFactory) : NxBlockObjectiveFactoryBase<NxBlockBreak>(loggerFactory) {
//    override fun create(instruction: Instruction, targetAmount: Variable<Number>, log: BetonQuestLogger, itemID: Variable<String>) =
//        NxBlockBreak(instruction, targetAmount, log, itemID)
//}